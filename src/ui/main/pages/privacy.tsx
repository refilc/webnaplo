    ...
    return (
        <div className="flex flex-col w-full h-full items-center justify-center">
            <div className="flex flex-col items-center justify-center px-10 pb-16 w-full">
                <h1 className='font-bold text-[45px] mt-16'>Adatvédelmi Irányelvek</h1>
                <h2 className='font-bold text-[20px] mt-16'>(Privacy Policy)</h2>
                <p className='text-[20px] opacity-70'>Utoljára módosítva: 2024. 02. 13.</p>
